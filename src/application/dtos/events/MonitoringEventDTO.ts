...
export interface MonitoringEventDTO extends InterfaceEventDTO {
    call: {
        type: TYPE_QUEUE,
...
export class MonitoringEventMapper {
    static toDTO(rawEvent: EventRaw): MonitoringEventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.MONITORING,
