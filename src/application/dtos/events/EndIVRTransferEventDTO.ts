...
export interface EndIVRTransferEventDTO extends InterfaceEventDTO {
    regenerated: boolean;
    call: {
        type: TYPE_QUEUE,
        waitingTime: number,
...
export class EndIVRTransferEventMapper {
    static toDTO(rawEvent: EventRaw): EndIVRTransferEventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.END_IVR_TRANSFER,
