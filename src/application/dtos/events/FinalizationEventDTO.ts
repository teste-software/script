...
export interface FinalizationEventDTO extends InterfaceEventDTO {
    call: {
        type: TYPE_QUEUE,
    }
}
...
export class FinalizationEventMapper {
    static toDTO(rawEvent: EventRaw): FinalizationEventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.FINALIZATION,
