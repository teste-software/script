...
export type CallbackEventDTO = InterfaceEventDTO

export class CallbackEventMapper {
    static toDTO(rawEvent: EventRaw): CallbackEventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.CALLBACK,
