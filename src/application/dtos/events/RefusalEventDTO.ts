...
export interface RefusalEventDTO extends InterfaceEventDTO {
    call: {
        type: TYPE_QUEUE,
    }
    branchesNumber: {
...
export class RefusalEventMapper {
    static toDTO(rawEvent: EventRaw): RefusalEventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.REFUSAL,
            ...
            branchesNumber: {
                destination: rawEvent.parameter0 as string,
            }
        };
