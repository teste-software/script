...
export interface EndCallEventDTO extends InterfaceEventDTO {
    regenerated: boolean,
    call: {
        type: TYPE_QUEUE,
        waitingTime: number,
...
export class EndCallEventMapper {
    static toDTO(rawEvent: EventRaw): EndCallEventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.END_CALL,
