...
export type EndIVREventDTO = InterfaceEventDTO


export class EndIVREventMapper {
    static toDTO(rawEvent: EventRaw): EndIVREventDTO {
        const event = {
            event: CALLS_TYPE_EVENTS_NAMES.END_IVR,
