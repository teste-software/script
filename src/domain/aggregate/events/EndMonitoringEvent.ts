...
export interface EventEndMonitoringDomain {
    clientId: ClientId,
    queueId: QueueId,
    queueName: QueueName,
...
export class EndMonitoringEventAggregate extends AggregateEvent {
    NAME_EVENT = CALLS_TYPE_EVENTS_NAMES.END_MONITORING;
    protected _event = {} as EventEndMonitoringDomain;
    NEXT_EVENTS_ALLOWED = [];
