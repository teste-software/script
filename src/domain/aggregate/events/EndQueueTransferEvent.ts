...
export interface EventEndQueueTransferDomain {
    clientId: ClientId,
    queueId: QueueId,
    queueName: QueueName,
...
export class EndQueueTransferEventAggregate extends AggregateEvent {
    NAME_EVENT = CALLS_TYPE_EVENTS_NAMES.END_QUEUE_TRANSFER;
    protected _event = {} as EventEndQueueTransferDomain;
    NEXT_EVENTS_ALLOWED = [];
