...
export interface EventEnterQueueDomain {
    clientId: ClientId,
    queueId: QueueId,
    queueName: QueueName,
...
export class EnterQueueEventAggregate extends AggregateEvent {
    protected _event = {} as EventEnterQueueDomain;
    NAME_EVENT = CALLS_TYPE_EVENTS_NAMES.ENTER_QUEUE
    NEXT_EVENTS_ALLOWED = [CALLS_TYPE_EVENTS_NAMES.END_CALL, CALLS_TYPE_EVENTS_NAMES.CALL_AGENT];
