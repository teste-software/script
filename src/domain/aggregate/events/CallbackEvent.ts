...
export interface EventCallbackDomain {
    clientId: ClientId,
    queueId: QueueId,
    queueName: QueueName,
...
export class CallbackEventAggregate extends AggregateEvent {
    NAME_EVENT = CALLS_TYPE_EVENTS_NAMES.CALLBACK
    protected _event = {} as EventCallbackDomain;
