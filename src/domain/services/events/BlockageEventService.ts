...
import {BlockageEventAggregate} from "../../aggregate/events/BlockageEvent";


@injectable()
export default class BlockageEventService extends EventService {
    constructor(
    ...
    override processEvent(callId: string, clientId: string, event: Event): CallSession {
        ...
        const eventAggregate = new BlockageEventAggregate(event);
    ...
    private updateParticipantBranches(callSession: CallSession, eventAggregate: BlockageEventAggregate) {
