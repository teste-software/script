...
import {CallAgentEventAggregate} from "../../aggregate/events/CallAgentEvent";


@injectable()
export default class CallAgentEventService extends EventService {
    ...
    override processEvent(callId: string, clientId: string, event: Event): CallSession {
        ...
        const eventAggregate = new CallAgentEventAggregate(event);
    ...
    private updateParticipantBranches(callSession: CallSession, eventAggregate: CallAgentEventAggregate) {
