...
@injectable()
export default class EndAnsweredEventService extends EventService {
    ...
    override processEvent(callId: string, clientId: string, event: Event): CallSession {
        ...
        const eventAggregate = new EndAnsweredEventAggregate(event);
    ...
    private updateParticipantBranches(callSession: CallSession, eventAggregate: EndAnsweredEventAggregate) {
