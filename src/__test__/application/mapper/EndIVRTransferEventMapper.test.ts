...
describe("EndIVRTransferEventMapper - FIMURATRANSFERENCIA", () => {

    test("Deve processar corretamente um evento de transferência finalizada via URA", () => {
        const rawEvent = {
            regenerated: false,
